...
namespace Lockstep{ 
    public class ListenableBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.Lockstep.Common.IListenable> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public ListenableBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.Lockstep.Common.IListenable>();
        ...
        private void _Unsupply(Regulus.Project.Lockstep.Common.IListenable obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.Lockstep.Common.IListenable obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.Lockstep.Common.IListenable>{}
