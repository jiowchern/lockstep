...
namespace Lockstep{ 
    ...
    {
        public string Agent;        
        Regulus.Remoting.INotifier<Regulus.Project.Lockstep.Common.IMatchable> _Notifier;
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Regulus.Project.Lockstep.Common.IMatchable>();
        ...
        private void _Unsupply(Regulus.Project.Lockstep.Common.IMatchable obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Regulus.Project.Lockstep.Common.IMatchable obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Regulus.Project.Lockstep.Common.IMatchable>{}
